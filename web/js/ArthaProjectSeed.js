...
app.registerExtension({
    name: "ComfyUI.Artha.Nodes.Artha.Project.Seed",
    ...
    async setup(app) {
        ...
        app.queuePrompt = async function(number, batchCount) {
            ...
            const projectSeedNodes = app.graph._nodes.filter(node => node.type === "ArthaProjectSeed");
    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        ...
        if (nodeData.name === "ArthaProjectSeed") {
