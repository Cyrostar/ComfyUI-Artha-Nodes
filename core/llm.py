...
def gemini_api_parameters(model="general"):
    ...
    return [    
        io.String.Input(
            ...
            multiline=False,
            tooltip=(
                "API key will be visible in plain text. "
                "Consider adding your api to the api.json located "
                "inside this custom node folder."
            ),
        ),
        ...
        io.Int.Input(
            ...
            tooltip=(
                ...
                "4 characters. 100 tokens is equal to about 60–80 "
                "English words."
            ),
        ),
        ...
        io.Float.Input(
            ...
            step=0.1,
            tooltip=(
                "A temperature of 0 means only the most likely tokens "
                "are selected. Higher values increase randomness."
            ),
        ),
    ]
