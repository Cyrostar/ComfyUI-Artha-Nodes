...
NODE_CLASS_MAPPINGS = {
    "Artha Gemini Question":  GeminiQuestion,
    "Artha Gemini Operation": GeminiOperation,
    "Artha Gemini Translate": GeminiTranslate,
    "Artha Gemini Imagen":    GeminiImagen,
    "Artha Gemini Speech":    GeminiSpeech,
    "Artha Gemini Vision":    GeminiVision,
    "Artha Gemini Motion":    GeminiMotion,
    "Artha Gemini Prompter":  GeminiPrompter,
    "Artha Gemini Condense":  GeminiCondense,
    "Artha Gemini Portrait":  GeminiPortrait,
    "Artha Gemini Face":      GeminiFace,
    "Artha Gemini Body":      GeminiBody,
    "Artha Gemini Form":      GeminiForm,
    "Artha Gemini Cloth":     GeminiCloth,
    "Artha Gemini Makeup":    GeminiMakeup,    
    "Artha Gemini Backdrop":  GeminiBackdrop,
    "Artha Gemini Compose":   GeminiCompose,
    "Artha Gemini Subject":   GeminiSubject,
    "Artha Gemini Scenery":   GeminiScenery,
    "Artha Gemini Camera":    GeminiCamera,
    "Artha Gemini Light":     GeminiLight,
    "Artha Gemini Style":     GeminiStyle,
    "Artha Gemini Response":  GeminiResponse,
    "Artha Gemini Markdown":  GeminiMarkdown,
    "Artha Gemini Instruct":  GeminiInstruct    
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "Artha Gemini Question":  node_prefix() + " Artha Gemini Question",
    "Artha Gemini Operation": node_prefix() + " Artha Gemini Operation",
    "Artha Gemini Translate": node_prefix() + " Artha Gemini Translate",
    "Artha Gemini Imagen":    node_prefix() + " Artha Gemini Imagen",
    "Artha Gemini Speech":    node_prefix() + " Artha Gemini Speech",
    "Artha Gemini Vision":    node_prefix() + " Artha Gemini Vision",
    "Artha Gemini Motion":    node_prefix() + " Artha Gemini Motion",
    "Artha Gemini Prompter":  node_prefix() + " Artha Gemini Prompter", 
    "Artha Gemini Condense":  node_prefix() + " Artha Gemini Condense", 
    "Artha Gemini Portrait":  node_prefix() + " Artha Gemini Portrait",
    "Artha Gemini Face":      node_prefix() + " Artha Gemini Face",
    "Artha Gemini Body":      node_prefix() + " Artha Gemini Body",
    "Artha Gemini Form":      node_prefix() + " Artha Gemini Form",
    "Artha Gemini Cloth":     node_prefix() + " Artha Gemini Cloth",
    "Artha Gemini Makeup":    node_prefix() + " Artha Gemini Makeup",
    "Artha Gemini Backdrop":  node_prefix() + " Artha Gemini Backdrop",
    "Artha Gemini Compose":   node_prefix() + " Artha Gemini Compose",
    "Artha Gemini Subject":   node_prefix() + " Artha Gemini Subject",
    "Artha Gemini Scenery":   node_prefix() + " Artha Gemini Scenery",
    "Artha Gemini Camera":    node_prefix() + " Artha Gemini Camera",
    "Artha Gemini Light":     node_prefix() + " Artha Gemini Light",
    "Artha Gemini Style":     node_prefix() + " Artha Gemini Style",
    "Artha Gemini Response":  node_prefix() + " Artha Gemini Response",
    "Artha Gemini Markdown":  node_prefix() + " Artha Gemini Markdown",
    "Artha Gemini Instruct":  node_prefix() + " Artha Gemini Instruct"    
}