...
NODE_DISPLAY_NAME_MAPPINGS = {
    "Gemini Question":  node_prefix() + " Artha Gemini Question",
    "Gemini Operation": node_prefix() + " Artha Gemini Operation",
    "Gemini Translate": node_prefix() + " Artha Gemini Translate",
    "Gemini Imagen":    node_prefix() + " Artha Gemini Imagen",
    "Gemini Speech":    node_prefix() + " Artha Gemini Speech",
    "Gemini Vision":    node_prefix() + " Artha Gemini Vision",
    "Gemini Motion":    node_prefix() + " Artha Gemini Motion",
    "Gemini Prompter":  node_prefix() + " Artha Gemini Prompter", 
    "Gemini Condense":  node_prefix() + " Artha Gemini Condense", 
    "Gemini Portrait":  node_prefix() + " Artha Gemini Portrait",
    "Gemini Face":      node_prefix() + " Artha Gemini Face",
    "Gemini Body":      node_prefix() + " Artha Gemini Body",
    "Gemini Form":      node_prefix() + " Artha Gemini Form",
    "Gemini Cloth":     node_prefix() + " Artha Gemini Cloth",
    "Gemini Makeup":    node_prefix() + " Artha Gemini Makeup",
    "Gemini Backdrop":  node_prefix() + " Artha Gemini Backdrop",
    "Gemini Compose":   node_prefix() + " Artha Gemini Compose",
    "Gemini Subject":   node_prefix() + " Artha Gemini Subject",
    "Gemini Scenery":   node_prefix() + " Artha Gemini Scenery",
    "Gemini Camera":    node_prefix() + " Artha Gemini Camera",
    "Gemini Light":     node_prefix() + " Artha Gemini Light",
    "Gemini Style":     node_prefix() + " Artha Gemini Style",
    "Gemini Response":  node_prefix() + " Artha Gemini Response",
    "Gemini Markdown":  node_prefix() + " Artha Gemini Markdown",
    "Gemini Instruct":  node_prefix() + " Artha Gemini Instruct"    
}